...
**Дата:** 12.09.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 869 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 1055 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 1238 мс | — |
| /uslugi/deratizaciya/ | ✅ 200 | 1106 мс | — |
| /blog/ | ✅ 200 | 845 мс | — |
| /contacts/ | ✅ 200 | 618 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 955 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 14.10.2026 | 32 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 955 | 1047 | -92 |
...
**Последнее обновление:** 12.09.2026 12:54 MSK
