...
**Дата:** 23.05.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 1093 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 978 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 1001 мс | — |
| /uslugi/deratizaciya/ | ✅ 200 | 1173 мс | — |
| /blog/ | ✅ 200 | 1272 мс | — |
| /contacts/ | ✅ 200 | 1091 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 1101 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 21.07.2026 | 59 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 1101 | 1115 | -14 |
...
**Последнее обновление:** 23.05.2026 11:10 MSK
