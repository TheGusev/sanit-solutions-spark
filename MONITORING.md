...
**Дата:** 10.09.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 1174 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 1164 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 1079 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 1079 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 14.10.2026 | 34 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 1079 | 816 | +263 |
...
**Последнее обновление:** 10.09.2026 13:22 MSK
