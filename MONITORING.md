...
**Дата:** 02.09.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 790 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 2472 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 772 мс | — |
| /uslugi/deratizaciya/ | ✅ 200 | 722 мс | — |
| /blog/ | ✅ 200 | 616 мс | — |
| /contacts/ | ✅ 200 | 602 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 995 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 14.10.2026 | 42 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 995 | 1085 | -90 |
...
**Последнее обновление:** 02.09.2026 13:21 MSK
