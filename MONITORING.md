...
**Дата:** 21.08.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 1193 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 806 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 1135 мс | — |
| /uslugi/deratizaciya/ | ✅ 200 | 1163 мс | — |
| /blog/ | ✅ 200 | 849 мс | — |
| /contacts/ | ✅ 200 | 936 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 1013 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 14.10.2026 | 54 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 1013 | 654 | +359 |
...
**Последнее обновление:** 21.08.2026 09:34 MSK
