...
**Дата:** 13.09.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 1084 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 979 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 1132 мс | — |
| /uslugi/deratizaciya/ | ✅ 200 | 1060 мс | — |
| /blog/ | ✅ 200 | 1060 мс | — |
| /contacts/ | ✅ 200 | 956 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 1045 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 14.10.2026 | 31 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 1045 | 955 | +90 |
...
**Последнее обновление:** 13.09.2026 13:54 MSK
