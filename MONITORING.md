...
**Дата:** 02.08.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 960 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 881 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 976 мс | — |
| /uslugi/deratizaciya/ | ✅ 200 | 965 мс | — |
| /blog/ | ✅ 200 | 653 мс | — |
| /contacts/ | ✅ 200 | 685 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 853 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 14.10.2026 | 73 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 853 | 729 | +124 |
...
**Последнее обновление:** 02.08.2026 11:10 MSK
