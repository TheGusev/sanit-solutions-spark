...
**Дата:** 30.07.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 1176 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 802 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 1252 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 911 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 14.10.2026 | 76 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 911 | 840 | +71 |
...
**Последнее обновление:** 30.07.2026 11:12 MSK
