...
**Дата:** 09.09.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 780 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 1223 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 887 мс | — |
| /uslugi/deratizaciya/ | ✅ 200 | 780 мс | — |
| /blog/ | ✅ 200 | 764 мс | — |
| /contacts/ | ✅ 200 | 465 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 816 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 14.10.2026 | 35 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 816 | 978 | -162 |
...
**Последнее обновление:** 09.09.2026 13:33 MSK
