...
**Дата:** 12.08.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 1008 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 943 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 808 мс | — |
| /uslugi/deratizaciya/ | ✅ 200 | 785 мс | — |
| /blog/ | ✅ 200 | 1117 мс | — |
| /contacts/ | ✅ 200 | 588 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 874 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 14.10.2026 | 63 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 874 | 1024 | -150 |
...
**Последнее обновление:** 12.08.2026 10:14 MSK
