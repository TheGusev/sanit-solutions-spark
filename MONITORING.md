...
**Дата:** 22.05.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 1275 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 1134 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 772 мс | — |
| /uslugi/deratizaciya/ | ✅ 200 | 1457 мс | — |
| /blog/ | ✅ 200 | 1080 мс | — |
| /contacts/ | ✅ 200 | 973 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 1115 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 21.07.2026 | 60 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 1115 | 919 | +196 |
...
**Последнее обновление:** 22.05.2026 11:52 MSK
