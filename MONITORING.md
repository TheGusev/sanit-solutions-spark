...
**Дата:** 21.05.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 1102 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 1206 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 969 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 919 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 21.07.2026 | 61 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 919 | 730 | +189 |
...
**Последнее обновление:** 21.05.2026 12:26 MSK
