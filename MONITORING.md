...
**Дата:** 06.08.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 875 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 1250 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 1250 мс | — |
| /uslugi/deratizaciya/ | ✅ 200 | 1231 мс | — |
| /blog/ | ✅ 200 | 1162 мс | — |
| /contacts/ | ✅ 200 | 627 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 1065 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 14.10.2026 | 69 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 1065 | 1023 | +42 |
...
**Последнее обновление:** 06.08.2026 11:22 MSK
