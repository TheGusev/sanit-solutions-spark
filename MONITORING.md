...
**Дата:** 24.07.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 1087 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 1144 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 1091 мс | — |
| /uslugi/deratizaciya/ | ✅ 200 | 1025 мс | — |
| /blog/ | ✅ 200 | 1074 мс | — |
| /contacts/ | ✅ 200 | 897 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 1053 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 14.10.2026 | 82 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 1053 | 720 | +333 |
...
**Последнее обновление:** 24.07.2026 11:13 MSK
