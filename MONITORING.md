...
**Дата:** 03.08.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 982 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 834 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 925 мс | — |
| /uslugi/deratizaciya/ | ✅ 200 | 790 мс | — |
| /blog/ | ✅ 200 | 960 мс | — |
| /contacts/ | ✅ 200 | 667 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 859 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 14.10.2026 | 72 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 859 | 853 | +6 |
...
**Последнее обновление:** 03.08.2026 12:31 MSK
