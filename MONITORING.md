...
**Дата:** 11.09.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 1219 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 1181 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 1215 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 1047 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 14.10.2026 | 33 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 1047 | 1079 | -32 |
...
**Последнее обновление:** 11.09.2026 13:23 MSK
