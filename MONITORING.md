...
**Дата:** 23.09.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 626 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 749 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 867 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 757 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 13.12.2026 | 81 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 757 | 702 | +55 |
...
**Последнее обновление:** 23.09.2026 13:34 MSK
