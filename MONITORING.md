...
**Дата:** 30.08.2026 | **Статус:** STABLE | **Финальный вердикт:** SAFE TO KEEP LIVE
...
|---|---|---:|---|
| / | ✅ 200 | 778 мс | — |
| /uslugi/dezinfekciya/ | ✅ 200 | 860 мс | — |
| /uslugi/dezinsekciya/ | ✅ 200 | 619 мс | — |
| /uslugi/deratizaciya/ | ✅ 200 | 617 мс | — |
| /blog/ | ✅ 200 | 752 мс | — |
| /contacts/ | ✅ 200 | 703 мс | — |
...
| Check | Result | Notes |
|---|---|---|
| Avg response time (key URLs) | 721 мс | Порог: 3000 мс |
| Largest HTML sample | 122.1 KB | Из representative audit |
| SSL сертификат | ✅ 14.10.2026 | 45 дн. до истечения |
...
| warnings | 0 | 0 | 0 |
| avg response time (мс) | 721 | 1008 | -287 |
...
**Последнее обновление:** 30.08.2026 14:00 MSK
