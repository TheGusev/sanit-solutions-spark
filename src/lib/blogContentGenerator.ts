...
const pestFAQTemplates = [
  ...
  },
  {
    ...
    answer: (_: string) => `Да, мы предоставляем гарантию сроком до 3 лет. Если вредители появятся снова в гарантийный период, проведём повторную обработку бесплатно.`,
  },
  {
