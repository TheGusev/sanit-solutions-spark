...
import { generateBreadcrumbSchema } from '@/lib/internalLinking';
...
interface BreadcrumbsProps {
  ...
  /** Whether to render BreadcrumbList JSON-LD schema. Default true. */
  showSchema?: boolean;
}

const Breadcrumbs = ({ items, showSchema = true }: BreadcrumbsProps) => {
  return (
    <>
      {showSchema && (
        <script
