...
const servicePricesData = [
  ...
  { id: 2, service: "Дезинфекция", object: "2-3 комнатная квартира", price: "от 2000 ₽" },
  { id: 3, service: "Дезинфекция", object: "Офис до 50 м²", price: "от 2500 ₽" },
  { id: 4, service: "Дезинфекция", object: "Склад от 100 м²", price: "от 3500 ₽" },
  { id: 5, service: "Дезинсекция (тараканы, клопы)", object: "1-комнатная квартира", price: "от 1200 ₽" },
  { id: 6, service: "Дезинсекция", object: "2-3 комнатная квартира", price: "от 2200 ₽" },
  { id: 7, service: "Дезинсекция", object: "Частный дом", price: "от 2800 ₽" },
  { id: 8, service: "Дератизация (крысы, мыши)", object: "Квартира", price: "от 1400 ₽" },
  { id: 9, service: "Дератизация", object: "Частный дом", price: "от 2500 ₽" },
  { id: 10, service: "Дератизация", object: "Склад/подвал", price: "от 3500 ₽" },
  { id: 11, service: "Озонирование", object: "Квартира до 50 м²", price: "от 800 ₽" },
  { id: 12, service: "Озонирование", object: "Офис 50-100 м²", price: "от 1500 ₽" },
  { id: 13, service: "Дезодорация", object: "Квартира", price: "от 1000 ₽" },
  { id: 14, service: "Дезодорация", object: "После пожара/затопления", price: "от 2500 ₽" },
  { id: 15, service: "Сертификация", object: "Документы для СЭС", price: "от 2000 ₽" },
];
