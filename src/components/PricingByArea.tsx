...
const servicePricesData = [
  { id: 1, service: "Дезинфекция", object: "1-комнатная квартира", price: "1000 ₽" },
  { id: 2, service: "Дезинфекция", object: "2-3 комнатная квартира", price: "1500 ₽" },
  { id: 3, service: "Дезинфекция", object: "Офис до 50 м²", price: "1800 ₽" },
  { id: 4, service: "Дезинфекция", object: "Склад от 100 м²", price: "2500 ₽" },
  { id: 5, service: "Дезинсекция (тараканы, клопы)", object: "1-комнатная квартира", price: "1200 ₽" },
  { id: 6, service: "Дезинсекция", object: "2-3 комнатная квартира", price: "1800 ₽" },
  { id: 7, service: "Дезинсекция", object: "Частный дом", price: "2000 ₽" },
  { id: 8, service: "Дератизация (крысы, мыши)", object: "Квартира", price: "1400 ₽" },
  { id: 9, service: "Дератизация", object: "Частный дом", price: "2000 ₽" },
  { id: 10, service: "Дератизация", object: "Склад/подвал", price: "2500 ₽" },
  { id: 11, service: "Озонирование", object: "Квартира до 50 м²", price: "1500 ₽" },
  { id: 12, service: "Озонирование", object: "Офис 50-100 м²", price: "2000 ₽" },
  { id: 13, service: "Дезодорация", object: "Квартира", price: "1200 ₽" },
  { id: 14, service: "Дезодорация", object: "После пожара/затопления", price: "2500 ₽" },
  { id: 15, service: "Демеркуризация", object: "Квартира (разбитый градусник)", price: "3000 ₽" },
  { id: 16, service: "Борьба с кротами", object: "Участок до 6 соток", price: "3000 ₽" },
  { id: 17, service: "Борьба с кротами", object: "Участок 6–15 соток", price: "5000 ₽" },
  { id: 18, service: "Обработка участков", object: "Участок до 6 соток", price: "4000 ₽" },
  { id: 19, service: "Обработка участков", object: "Участок 6–10 соток", price: "5500 ₽" },
  { id: 20, service: "Обработка участков", object: "Участок 10–20 соток", price: "8000 ₽" },
];
