...
const DistrictCTA = ({ district }: DistrictCTAProps) => {
  // Generate stats based on district
  const getStats = () => {
    const baseObjects = {
      cao: 312,
      sao: 287,
    ...
    return {
      objectsCount: baseObjects[district.id as keyof typeof baseObjects] || 200,
        ...
        <div className="bg-gradient-to-br from-primary to-green-600 rounded-2xl p-8 md:p-12 text-white text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">
              Закажите дезинфекцию в {district.name} прямо сейчас
            </h2>
