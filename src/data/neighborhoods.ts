...
const genFAQ = (name: string, responseTime: string, surcharge: number): NeighborhoodFAQ[] => [
  ...
  },
  {
    ...
    answer: `Да, мы даём гарантию 1 год на все виды работ. Если вредители вернутся — проведём повторную обработку бесплатно.`
  }
];
...
const caoNeighborhoods: Neighborhood[] = [
  ...
  },
  {
    ...
    metaDescription: 'Дезинфекция на Таганке Москвы. Уничтожение тараканов, клопов, грызунов. Гарантия 1 год.',
