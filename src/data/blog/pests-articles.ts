...
В стоимость входит: диагностика, обработка, консультация по профилактике и гарантия до 3 лет.
    `,
...
:::
    ...
    tldrGenerator: (pest: typeof pests[0]) => [
      ...
      `Гарантия: до 3 лет, повторный выезд бесплатно`,
...
Точную стоимость можно узнать по телефону или после бесплатного осмотра помещения.
    ...
    tldrGenerator: (pest: typeof pests[0]) => [
      ...
      `Частный дом: от ${Math.round(pest.priceFrom * 1.5)}₽`,
      `В стоимость входит: диагностика, препараты, гарантия до 3 лет`,
