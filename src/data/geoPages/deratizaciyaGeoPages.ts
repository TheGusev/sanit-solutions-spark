...
const deratizaciyaPricing: GeoPagePricing = {
  apartments: [
    { type: '1-комнатная', area: '30-40 м²', price: '1 400 ₽', time: '1-2 ч' },
    { type: '2-комнатная', area: '45-60 м²', price: '2 500 ₽', time: '2-3 ч' },
    { type: '3-комнатная', area: '60-80 м²', price: '3 500 ₽', time: '3-4 ч' },
    { type: '4+ комнатная', area: '80+ м²', price: 'от 4 500 ₽', time: '4+ ч' }
  ],
  offices: [
    { area: 'До 100 м²', price: '4 500 ₽', time: '3-4 ч' },
    { area: '100-300 м²', price: '12 000 ₽', time: '5-6 ч' },
    { area: '300-500 м²', price: '20 000 ₽', time: '7-8 ч' },
    { area: 'Более 500 м²', price: 'Индивидуально', time: 'от 10 ч' }
  ],
  restaurants: [
    { type: 'Кафе/кофейня (до 50 м²)', price: '3 500 ₽', frequency: 'Раз в месяц' },
    { type: 'Ресторан (50-150 м²)', price: '7 000 ₽', frequency: 'Раз в месяц' },
...
export const deratizaciyaGeoPages: GeoPageData[] = [
  // ЦАО
  {
    ...
    seo: {
      title: 'Дератизация в ЦАО Москвы – уничтожение крыс и мышей | от 1400₽',
  ...
  // САО
  {
    ...
    seo: {
      title: 'Дератизация в САО Москвы – уничтожение крыс и мышей | от 1400₽',
  ...
  // СВАО
  {
    ...
    seo: {
      title: 'Дератизация в СВАО Москвы – уничтожение мышей и крыс | от 1400₽',
  ...
  // ВАО
  {
    ...
    seo: {
      title: 'Дератизация в ВАО Москвы – уничтожение крыс и мышей | от 1400₽',
  ...
  // ЮВАО
  {
    ...
    seo: {
      title: 'Дератизация в ЮВАО Москвы – уничтожение мышей и крыс | от 1400₽',
  ...
  // ЮАО
  {
    ...
    seo: {
      title: 'Дератизация в ЮАО Москвы – уничтожение крыс и мышей | от 1400₽',
  ...
  // ЮЗАО
  {
    ...
    seo: {
      title: 'Дератизация в ЮЗАО Москвы – уничтожение мышей | от 1400₽',
  ...
  // ЗАО
  {
    ...
    seo: {
      title: 'Дератизация в ЗАО Москвы – уничтожение крыс и мышей | от 1400₽',
  ...
  // СЗАО
  {
    ...
    seo: {
      title: 'Дератизация в СЗАО Москвы – уничтожение мышей и крыс | от 1400₽',
